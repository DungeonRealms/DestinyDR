    ...
    public void onPlayerJoin(PlayerJoinEvent event) {
        ...
        if (onTutorialIsland(pl.getLocation())) {
            Bukkit.getScheduler().scheduleSyncDelayedTask(DungeonRealms.getInstance(), () -> {
                ...
                pl.sendMessage("");
                pl.sendMessage(ChatColor.GRAY + "You'll get a crash course on interactable mechanics and " + ChatColor.UNDERLINE + "get free loot" + ChatColor.GRAY + " just for completing it!");
                pl.sendMessage("");
            }, 80L);
            Bukkit.getScheduler().scheduleSyncDelayedTask(DungeonRealms.getInstance(), () -> {
    ...
    public void onPlayerInteractNPC(PlayerInteractEntityEvent e) {
        ...
        if (npc.getName().equalsIgnoreCase("Ship Captain")) {
            ...
            final List<String> messages = Arrays.asList(
                    ...
                    "Tier 1 requires a level of 1 (generic level).",
                    ...
                    "A tier 1 horse requires level 1 (generic level)",
