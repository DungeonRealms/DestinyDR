package net.dungeonrealms.old.game.world.item;
...
public class DamageAPI
{
    ...
    public static double calculateWeaponDamage(LivingEntity attacker, LivingEntity receiver)
    {
        ...
        { // SAFETY CHECK todo: debug everything causing exceptions
...
//            }
            ...
            // THORNS
            if (defenderAttributes.get("thorns")[1] != 0 && projectile == null)
            { // thorns only applies for melee
                // combat now
