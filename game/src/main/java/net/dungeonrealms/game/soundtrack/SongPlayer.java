...
import net.dungeonrealms.game.soundtrack.decipher.Interpolator;
import net.dungeonrealms.game.soundtrack.event.SongDestroyingEvent;
import net.dungeonrealms.game.soundtrack.event.SongEndEvent;
import net.dungeonrealms.game.soundtrack.event.SongStoppedEvent;
import net.dungeonrealms.game.soundtrack.player.song.FadeType;
