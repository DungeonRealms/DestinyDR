 ...
 */
public class ArmorEnchantMerchantReward extends AbstractMerchantReward {

    private Item.ItemTier enchantTier;
    private int scrapAmountRequired;

    public ArmorEnchantMerchantReward(Item.ItemTier enchantTier, int scrapAmountRequired) {
    ...
    public void giveReward(Player player, int amountToPurchase) {
        for(int k = 0; k < amountToPurchase; k++) {
            ItemEnchantArmor toGive = new ItemEnchantArmor(enchantTier);
    ...
    public List<String> getLore() {
        ...
        toReturn.add("1x Tier " + enchantTier.getId() + " Armor Enchant");
