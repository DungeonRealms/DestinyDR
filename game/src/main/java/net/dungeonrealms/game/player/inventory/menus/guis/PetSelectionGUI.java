...
public class PetSelectionGUI extends GUIMenu {
    ...
    protected void setItems() {
        ...
        Map<EnumPets, String> playerPets = wrapper.getPetsUnlocked();
        ...
        for (EnumPets pets : EnumPets.values()) {
            ...
            String name = playerPets.get(pets);

//            AtomicBoolean isLocked = new AtomicBoolean(name == null || !hisData.isUnlocked());
