 ...
 */
public class T4RecipeArmor extends AbstractRecipe {
    @Override
    ...
    public void giveReward(Player player) {
        ItemResistancePotion potion = new ItemResistancePotion(600, 1);
    ...
    public String getRewardDescription() {
        return "+35% Armor for 10 minutes";
    }
