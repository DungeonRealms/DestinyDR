...
import net.dungeonrealms.game.item.items.core.ItemArmorBoots;
import net.dungeonrealms.game.item.items.core.ItemArmorChestplate;
import net.dungeonrealms.game.item.items.core.ItemArmorHelmet;
import net.dungeonrealms.game.item.items.core.ItemArmorLeggings;
 ...
 */
public class T5RecipeArmor extends AbstractRecipe {
    @Override
    ...
    public void giveReward(Player player) {
        ItemResistancePotion potion = new ItemResistancePotion(600, 2);
    ...
    public String getRewardDescription() {
        return "+60% Armor for 10 minutes";
    }
