 ...
 */
public class T3RecipeDPS extends AbstractRecipe {
    @Override
    ...
    public void giveReward(Player player) {
        ItemStrengthPotion potion = new ItemStrengthPotion(600, 0);
