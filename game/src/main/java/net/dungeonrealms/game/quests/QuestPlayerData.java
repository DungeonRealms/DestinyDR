...
public class QuestPlayerData {
    ...
    public boolean removeQuest(Quest quest) {
        return this.qip.stream().filter(progress -> progress != null && progress.getQuest() != null && progress.getQuest().equals(quest)).findFirst().filter(progress -> this.qip.remove(progress)).isPresent();
    }
