...
public class Burick extends MeleeWitherSkeleton implements DungeonBoss {
    ...
    public Burick(World world) {
        ...
        this.fireProof = true;
        this.collides = true;
        getAttributeInstance(GenericAttributes.c).setValue(.50F);
    ...
    public void startEnragedMode() {
        ...
        getAttributeInstance(GenericAttributes.MOVEMENT_SPEED).setValue(getAttributeInstance(GenericAttributes.MOVEMENT_SPEED).getValue() * 1.458);
