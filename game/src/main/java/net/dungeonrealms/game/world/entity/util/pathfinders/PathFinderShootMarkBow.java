...
import net.dungeonrealms.game.world.entity.type.monster.type.ranged.RangedUtilityZombie;
...
public class PathFinderShootMarkBow extends PathfinderGoal {
    private final RangedUtilityZombie a;
    ...
    public PathFinderShootMarkBow(RangedUtilityZombie var1, double var2, int var4, float var5) {
        this.a = var1;
        this.b = var2;
        this.c = var4;
        this.d = var5 * var5;
