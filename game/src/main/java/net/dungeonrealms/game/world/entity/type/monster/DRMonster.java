...
public interface DRMonster {
    ...
    public static final TeleportLocation[][] TELEPORT_DROPS = new TeleportLocation[][]{
            ...
            {TeleportLocation.CYRENNICA, TeleportLocation.HARRISON_FIELD, TeleportLocation.DARK_OAK, TeleportLocation.TROLLSBANE, TeleportLocation.TRIPOLI, TeleportLocation.CRESTWATCH, TeleportLocation.AVALON},
            {TeleportLocation.CYRENNICA, TeleportLocation.DARK_OAK, TeleportLocation.TROLLSBANE, TeleportLocation.GLOOMY_HOLLOWS, TeleportLocation.CRESTGUARD, TeleportLocation.CRESTWATCH, TeleportLocation.AVALON},
