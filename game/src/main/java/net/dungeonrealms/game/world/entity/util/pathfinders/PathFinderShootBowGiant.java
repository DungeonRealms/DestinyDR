...
/**
 * Created by Rar349 on 8-Jun-17.
 */
public class PathFinderShootBowGiant extends PathfinderGoal {
    private final RangedGiant a;
    ...
    public PathFinderShootBowGiant(RangedGiant var1, double var2, int var4, float var5) {
        this.a = var1;
        this.b = var2;
        this.c = var4;
        this.d = var5 * var5;
