...
public class Item {
    ...
    public enum AttributeBank {
    	...
    	@Getter private AttributeType[] attributes;
    	private double[] repairMultipliers;
    	@Getter private double globalRepairMultiplier;
    ...
    public enum FishingAttributeType implements ProfessionAttribute {
    	...
    	@Getter private String NBTName;
    	@Getter private int[] percentRange;
    ...
    public enum WeaponAttributeType implements AttributeType {
        ...
        @Getter private int displayPriority;
        @Getter private String displayPrefix;
        private String displaySuffix;
        @Getter private String NBTName;
        @Getter private int chance;
        @Getter private boolean percentage;
        @Getter private boolean range;
        @Getter private boolean includeOnReroll;
