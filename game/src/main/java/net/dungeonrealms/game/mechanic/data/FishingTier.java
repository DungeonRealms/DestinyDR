...
public enum FishingTier implements ProfessionTier {
    ...
    TIER_1(0, 20, 10, 100 * 2, EnumAchievements.FISHINGROD_LEVEL_I, "Basic", "wood and thread"),
    TIER_2(20, 18, 20, 250 * 2, EnumAchievements.FISHINGROD_LEVEL_II, "Advanced", "oak wood and thread"),
    TIER_3(40, 15, 30, 300 * 2, EnumAchievements.FISHINGROD_LEVEL_III, "Expert", "ancient oak wood and spider silk"),
    TIER_4(60, 15, 40, 500 * 2, EnumAchievements.FISHINGROD_LEVEL_IV, "Supreme", "jungle bamboo and spider silk"),
    TIER_5(80, 15, 50, 600 * 2, EnumAchievements.FISHINGROD_LEVEL_IV, "Master", "rich mahogany and enchanted silk");
