...
public enum HorseTier {
	...
	TIER_3(EnumMounts.TIER3_HORSE, Material.DIAMOND_BARDING, "A well versed travelling companion.", 15000, 170, .25F, 115),
	TIER_4(EnumMounts.TIER4_HORSE, Material.GOLD_BARDING, "A mount fit for even the best of adventurers.", 30000, 200, .245F, 125),
	MULE(EnumMounts.MULE, Material.SADDLE, "An old worn mule.", 5000, 0, .2F, 0);
