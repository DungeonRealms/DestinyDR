...
public enum ScrapTier {
    ...
    TIER1(1, "Leather", ChatColor.WHITE, Material.LEATHER, (byte) 0, 25, EnumData.CURRENCY_TAB_T1, 80, 70, -1),
    TIER2(2, "Chain", ChatColor.GREEN, Material.IRON_FENCE, (byte) 0, 30, EnumData.CURRENCY_TAB_T2, 140, 125, -1),
    TIER3(3, "Iron", ChatColor.AQUA, Material.INK_SACK, (byte) 7, 42, EnumData.CURRENCY_TAB_T3, 110, 100, -1),
    TIER4(4, "Diamond", ChatColor.LIGHT_PURPLE, Material.INK_SACK, DyeColor.LIGHT_BLUE.getDyeData(), 57, EnumData.CURRENCY_TAB_T4, 88, 80, 60),
    TIER5(5, "Gold", ChatColor.YELLOW, Material.INK_SACK, DyeColor.YELLOW.getDyeData(), 41, EnumData.CURRENCY_TAB_T5, 33, 30, 20);
