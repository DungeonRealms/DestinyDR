...
public enum Stats {
	...
	DEXTERITY(ArmorAttributeType.DEXTERITY, "Dexterity", new String[] {"Adds DPS%, dodge chance, vs", "monsters, and bow damage."}, 12/*, new StatBoost(ArmorAttributeType.DAMAGE, .0003f), new StatBoost(ArmorAttributeType.DODGE, .0002f), new StatBoost(WeaponAttributeType.ARMOR_PENETRATION, .0002F)*/),
	VITALITY(ArmorAttributeType.VITALITY, "Vitality", new String[] {"Adds health, hp regen,", "elemental resistance and", "sword damage."}, 13/*, new StatBoost(ArmorAttributeType.HEALTH_REGEN, .003f)*/),
