...
public enum Stats {
	...
	INTELLECT(ArmorAttributeType.INTELLECT, "Intellect", new String[] {"Adds energy regeneration, critical,",  "hit chance, and staff damage."}, 14, new StatBoost(ArmorAttributeType.ENERGY_REGEN, .015f));
