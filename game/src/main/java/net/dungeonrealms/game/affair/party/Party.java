...
public class Party {
    ...
    @Getter
    @Setter
    private boolean updateScoreboard = false;
    ...
    public void addMember(Player player) {
        ...
        Achievements.giveAchievement(player, EnumAchievements.PARTY_UP);
    }
    ...
    public List<Player> getNearbyMembers(Player player, int radius) {
