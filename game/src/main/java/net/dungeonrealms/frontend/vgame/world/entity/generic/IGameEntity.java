package net.dungeonrealms.frontend.vgame.world.entity.generic;
...
import net.dungeonrealms.frontend.vgame.world.entity.generic.construct.health.EntityHealthBar;
import net.dungeonrealms.frontend.vgame.world.location.GameLocation;
