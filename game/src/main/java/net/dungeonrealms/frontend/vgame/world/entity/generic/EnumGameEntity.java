...
import net.dungeonrealms.frontend.vgame.world.entity.generic.type.EntityBandit;
import net.dungeonrealms.frontend.vgame.world.entity.generic.type.EntitySkeleton;
