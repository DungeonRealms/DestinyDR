...
import net.dungeonrealms.game.item.items.core.setbonus.SetBonusListener;
...
public class DungeonRealms extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        pm.registerEvents(new SetBonusListener(), this);
        ...
        cm.registerCommand(new CommandLock());
        ...
        cm.registerCommand(new CommandLink());
        ...
        cm.registerCommand(new CommandStaffChat("staff", PlayerRank.PMOD, "SC", "s"));
        ...
        // Commands only registered for live servers (including always registered).
            ...
            cm.registerCommand(new CommandPack());
...
//            cm.registerCommand(new CommandMail("mailbox", "/<command> [args]", "Manage your received mail and send your own mail."));
            ...
            cm.registerCommand(new CommandDiscord());
