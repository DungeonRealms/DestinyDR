 ...
 */
public class CreatureSnowGolem extends EntitySnowman implements ICreature {
    @Getter
    private EnumEntityType entityType = EnumEntityType.SNOW_GOLEM;
    ...
    public CreatureSnowGolem(World world, EnumIntelligenceType intelligenceType) {
        super(world);
