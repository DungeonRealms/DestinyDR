...
import net.dungeonrealms.api.creature.lib.craft.horse.IHorse;
 ...
 */
public class CreatureHorse extends EntityHorse implements IHorse {

    @Getter
    private EnumEntityType entityType = EnumEntityType.HORSE;
