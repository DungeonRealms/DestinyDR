 ...
 */
public class CreatureSpider extends EntitySpider implements ICreature {
    @Getter
    private EnumEntityType entityType = EnumEntityType.SPIDER;
    ...
    public CreatureSpider(World world, EnumIntelligenceType intelligenceType) {
        super(world);
