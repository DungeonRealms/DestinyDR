 ...
 */
public class CreatureSheep extends EntitySheep implements ICreature {

    @Getter
    private EnumEntityType entityType = EnumEntityType.SHEEP;
    ...
    public CreatureSheep(World world, EnumIntelligenceType intelligenceType) {
        super(world);
