...
//        }
    ...
    public static void logoutAllPlayers() {
        GameAPI.IGNORE_QUIT_EVENT.clear();
    ...
    public static void moveToShard(Player player, String serverBungeeName) {
        ...
        submitAsyncCallback(() -> {
            ...
            final Future<Boolean> successful = consumer;
            try {
                if (successful.get()) {
                    ...
                    player.sendMessage(ChatColor.RED + "Error 30: Your player data failed to upload. Please try again.");
                }
            }
            catch (Exception ex) {
                ex.printStackTrace();
