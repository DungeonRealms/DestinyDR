...
public enum PlayerRank {
    ...
    PMOD("PMOD", ChatColor.WHITE, "WHITE", "Player Moderator", "nocheatplus.notify", "nocheatplus.command.notify", "nocheatplus.command.info", "nocheatplus.command.inspect"),
    TRIALGM("GM", ChatColor.AQUA, "LIGHT_BLUE", "Trial Game Master", "nocheatplus.checks", "nocheatplus.bypass.denylogin", "essentials.*", "nocheatplus.bypass.denylogin", "bukkit.command.teleport", "minecraft.command.tp"),
    GM("GM", ChatColor.AQUA, "LIGHT_BLUE", "Game Master"),
