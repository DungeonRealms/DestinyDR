package net.dungeonrealms.common.awt.frame.task;

import lombok.Getter;
import net.dungeonrealms.common.awt.frame.task.data.EnumTaskPurpose;
import net.dungeonrealms.common.awt.frame.task.data.EnumTaskSetting;
import net.dungeonrealms.common.awt.frame.task.data.EnumTaskType;
