...
public class Constants {
    ...
    public static List<String> DEVELOPERS = Arrays.asList("Detoxen", "Kneesnap", "Kihz", "Lana", "Sad", "SecondAmendment");
    ...
    public static String MASTER_SERVER_IP = "142.44.137.87";
    // BACKEND SERVER SERVER PORT //
