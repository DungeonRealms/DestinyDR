...
public class HealthHandler implements GenericMechanic {
    ...
    private void setPlayerOverheadHP(Player player, int hp) {
        ...
        String playerEXPInfo = ChatColor.LIGHT_PURPLE.toString() + ChatColor.BOLD + "XP " + ChatColor.LIGHT_PURPLE + Math.round((gamePlayer.getExperience() / gamePlayer.getEXPNeeded(playerLevel) + 1) * 100.0) + "%";
        if (playerLevel == 100) {
