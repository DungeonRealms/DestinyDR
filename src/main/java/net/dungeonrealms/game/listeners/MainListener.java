...
public class MainListener implements Listener {
    ...
    public void onJoin(PlayerJoinEvent event) {
        ...
        BountifulAPI.sendTitle(player, 1, 20 * 3, 1, ChatColor.GREEN.toString() + ChatColor.BOLD + "Loading character for '" + player.getName() + "' ...", ChatColor.GRAY.toString() + "Do not disconnect");
