        ...
        public static Stats getRandomStats(int lvl, int tier) {
            ...
            switch (tier) {
                ...
                case 5:
                    ...
                    lvlhp = Math.abs((lvl * 75) + (random.nextInt(150) - 100));
