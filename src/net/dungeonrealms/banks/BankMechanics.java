...
public class BankMechanics {
    ...
    private static void loadCurrency() {
        ...
        nms.setTag(tag);
        gem = AntiCheat.getInstance().applyAntiDupe(CraftItemStack.asBukkitCopy(nms));
        ...
        tag2.setInt("worth", 0);
        nms2.setTag(tag2);
        banknote = AntiCheat.getInstance().applyAntiDupe(CraftItemStack.asBukkitCopy(nms2));
    }
    ...
    public static ItemStack createBankNote(int amount) {
        ...
        nms2.setTag(tag2);
        return AntiCheat.getInstance().applyAntiDupe(CraftItemStack.asBukkitCopy(nms2));
    }
