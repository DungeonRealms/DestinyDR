...
//     * @since 1.0
//     */
//    public int nextArmor(Armor.ArmorTier tier, Armor.ItemRarity rarity, Armor.ArmorAttributeType type) {
//        switch (tier) {
//            case TIER_1:
//                switch (rarity) {
//                    case COMMON:
...
//     * @since 1.0
//     */
//    public int nextWeapon(Item.ItemTier tier, Item.ItemRarity rarity, Item.AttributeType type) {
//        switch (tier) {
//            case TIER_1:
//                switch (rarity) {
//                    case COMMON:
